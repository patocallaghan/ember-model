...
test("when no properties have changed on a model, save should noop", function(assert) {
...
test("when properties have changed on a model, isDirty should be set", function(assert) {
  assert.expect(3);
...
test("when properties are changed back to the loaded value, isDirty should be false", function(assert) {
  assert.expect(6);
...
test("after saving, the model shouldn't be dirty", function(assert) {
  assert.expect(3);
...
test("after reloading, the model shouldn't be dirty", function(assert) {
  assert.expect(2);
...
test("dirty checking works with boolean attributes", function(assert) {
  var Model = Ember.Model.extend({
...
test("dirty checking works with date attributes", function(assert) {
  var Model = Ember.Model.extend({
    createdAt: attr(Date)
  });
...
test("getting embedded belongsTo attribute after load should not make parent dirty", function(assert) {
  assert.expect(2);
  var json = {
    id: 1,
    name: 'foo',
...
test("loading record with embedded hasMany attribute should not make it dirty", function(assert) {
  assert.expect(3);
...
test("isDirty is observable", function(assert) {
  assert.expect(2);
...
test("manipulating object presence in a hasMany should dirty the parent", function(assert) {
  assert.expect(7);
  var Comment = Ember.Model.extend();
...
test("manipulating the order of objects in a hasMany shouldn't dirty the parent", function(assert) {
  var Comment = Ember.Model.extend({
    id: Ember.attr()
  });
...
test("modifying hasMany record should make parent dirty", function(assert) {
  var Author = Ember.Model.extend({
        id: Ember.attr(),
        name: Ember.attr()
      }),
...
test("changing back record in hasMany array should make parent clean again", function(assert) {
  var Author = Ember.Model.extend({
        id: Ember.attr(),
        name: Ember.attr()
      }),
...
test("manipulating object presence in hasMany array should be reflected in it's _modifiedRecords property", function(assert) {
  var Comment = Ember.Model.extend();
...
test("_modifiedRecords property should be clean after clearing hasMany array", function(assert) {
  var Comment = Ember.Model.extend();
...
test("isDirty on embedded hasMany records should be false after parent is saved", function(assert) {
  assert.expect(9);
...
test("modifying embedded belongsTo should make parent dirty", function(assert) {
  assert.expect(3);
  var json = {
    id: 1,
    name: 'foo',
...
test("changing back embedded belongsTo should make parent clean again", function(assert) {
  assert.expect(3);
  var json = {
    id: 1,
    name: 'foo',
...
test("save parent of embedded belongsTo", function(assert) {
  assert.expect(9);
  var json = {
    id: 1,
    name: 'foo',
...
test("save parent of embedded belongsTo with different named key", function(assert) {
  assert.expect(9);
  var json = {
    id: 1,
    name: 'foo',
...
test("set embedded belongsTo", function(assert) {
  assert.expect(9);
  var json = {
    id: 1,
    name: 'foo',
...
test("set embedded belongsTo cleans up observers", function(assert) {
  assert.expect(5);
  var json = {
    id: 1,
    name: 'foo',
...
test("manipulating the content of objects in a hasMany should dirty the parent", function(assert) {
  assert.expect(4);
