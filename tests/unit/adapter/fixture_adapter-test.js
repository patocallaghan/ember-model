...
test("fetch loads the full FIXTURES payload when id isn't specified", function(assert) {
  assert.expect(1);
...
test("fetch loads the desired FIXTURE payload when the id (int) is specified", function(assert) {
  assert.expect(1);
...
test("fetch loads the desired FIXTURE payload when the id (string) is specified", function(assert) {
  assert.expect(1);
...
test("createRecord - handle the case when the `rootKey` property is set", function(assert) {
  assert.expect(1);
...
test("_generatePrimaryKey", function(assert) {
  assert.expect(3);
