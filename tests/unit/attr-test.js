...
test("getAttr hook is called when attribute is fetched", function(assert) {
  assert.expect(2);
...
test("attr should not change null to object", function(assert) {
  var Page = Ember.Model.extend({
    author: attr()
  });
  var page = Page.create();
...
test("attr should deserialize when type has a deserialize method", function(assert) {
  var Time = {
...
test("attr should serialize when type has a serialize method", function(assert) {
  var Time = {
...
test("attr should know how to serialize some built in objects", function(assert) {
  assert.expect(7);
...
test("attr should know how to deserialize some built in objects", function(assert) {
  assert.expect(8);
...
test("attr should camelize attributes when reading", function(assert) {
  var Page = Ember.Model.extend({
    someAuthor: attr()
  });
...
test("attr should camelize attributes when writing", function(assert) {
  var Page = Ember.Model.extend({
    someAuthor: attr()
  });
  Page.camelizeKeys = true;
...
test("toJSON should respect the key option in attr", function(assert) {
  var Page = Ember.Model.extend({
...
test("custom attributes should revert correctly", function(assert) {
  var Time = {
...
test("attr should handle default values", function(assert) {
